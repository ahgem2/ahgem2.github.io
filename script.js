...
const questions = [
  {
    ...
    options: ["Early morning, too tired for this", "Late morning, ready for lunch", "Afternoon snack time", "Dinner time!"],
    gifs: {
  ...
  },
  {
    ...
    options: ["Starving!", "Comfortably full", "Barely hungry", "Refreshed and light"],
    gifs: {
  ...
  },
  {
    ...
    options: ["Barely got a dollar", "Mid-range, nothing fancy", "Money's no issue, treat yourself!", "Home cooking"],
    gifs: {
  ...
  },
  {
    ...
    options: ["Cozy at home", "Fancy restaurant", "Picnic", "Frolicking in grassy fields"],
    gifs: {
...
const foodResults = {
  "Orange": {
    ...
    matches: ["Refreshed and light", "Frolicking in grassy fields", "Mid-range, nothing fancy"]
  },
  "Pasta": {
    gif: "assets/pasta.gif",
    description: "Reliable, comforting, and infinitely versatile - you appreciate the classics with your own unique twist.",
    fortune: "Your adaptability will help you overcome any challenge this week.",
    matches: ["Comfortably full", "Fancy restaurant", "Mid-range, nothing fancy"]
  },
  "Sandwich": {
    gif: "assets/sandwich.gif",
    description: "Practical, dependable, and always satisfying. You're the friend everyone can count on!",
  ...
  "Korean BBQ or Hotpot": {
    gif: "assets/bbq.gif",
    description: "Social, adventurous, and always up for a good time. You bring people together!",
    fortune: "A gathering with friends will lead to a meaningful connection.",
    matches: ["Dinner time!", "Money's no issue, treat yourself!", "Fancy restaurant"]
  },
  "Chocolate": {
    gif: "assets/chocolate.gif",
    description: "Sweet, indulgent, and impossible not to love. You know how to enjoy life's little pleasures.",
  ...
  "Noodles": {
    ...
    description: "Long-lasting, flexible, and full of variety. Your life is rich with experiences and possibilities!",
    fortune: "An unexpected journey will bring new knowledge.",
    matches: ["Starving!", "Late morning, ready for lunch", "Mid-range, nothing fancy"]
  },
  "Strawberry Cake": {
    gif: "assets/cake.gif",
    description: "Sweet, special, and meant to be celebrated. You bring joy to those around you!",
    fortune: "A celebration is in your near future - big or small, it will be meaningful.",
    matches: ["Barely hungry", "Money's no issue, treat yourself!", "Cozy at home"]
  },
  "Homemade Fried Rice": {
    gif: "assets/friedrice.gif",
    description: "Resourceful, creative, and comforting. You make the most of what you have!",
